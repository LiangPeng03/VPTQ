...
# 添加导入OPT模型相关模块
from vptq.models.opt import eval_opt, get_opt, quant_opt
...
if __name__ == "__main__":
    ...
    if args.eval and hasattr(model, 'config') and "opt" in args.model_name.lower():
        print("Evaluating original model performance before quantization...")
        eval_results = eval_opt(model, args)
