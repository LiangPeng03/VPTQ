...
# --------------------------------------------------------------------------
# Model adapted from https://github.com/Cornell-RelaxML/quip-sharp/blob/main/model/llama.py
# Evaluation from https://github.com/IST-DASLab/gptq/blob/main/eval.py
...
def quant_opt(model, args, quant_args, dev='cuda'):
    ...
    # get decoder layers - OPT models store layers in model.decoder.layers
